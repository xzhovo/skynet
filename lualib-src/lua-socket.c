...
llisten(lua_State *L) {
	...
	int backlog = luaL_optinteger(L,3,BACKLOG); // arg[3] or BACKLOG
	struct skynet_context * ctx = lua_touserdata(L, lua_upvalueindex(1)); // service_snlua.c:init_cb 中 lua_setfield
